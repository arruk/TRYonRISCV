...
module torv32 (
	...
	always @(posedge clk) begin
		if (!a_f_stall) begin
			...
			f_PC <= (control_HAZ & !a_fd_NOP) ? f_PC + 4 : f_PC + 8;
	...
	*/
	...
	wire [31:0] a_e_ALUin2 = aC_de_ALUin2[0] ? a_e_rs2 : aC_de_ALUin2[1] ? a_de_IMM : 32'd4;
	...
	*/
	...
	wire [31:0] b_e_ALUin2 = bC_de_ALUin2[0] ? b_e_rs2 : bC_de_ALUin2[1] ? b_de_IMM : 32'd4;
