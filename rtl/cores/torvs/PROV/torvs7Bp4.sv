...
module torv32 (
	...
	reg [31:0] a_de_IR  /* synthesis syn_maxfan = 100 */, a_de_PC;
	reg a_de_predict;
	...
	*/
	...
	reg [31:0] a_mw_IR, a_mw_PC, a_mw_RES, a_mw_IO_RES, a_mw_ADDR, a_mw_CSR_RES;
	reg
		a_mw_lb  /* synthesis syn_maxfan = 50 */,
		a_mw_lbu  /* synthesis syn_maxfan = 50 */,
		a_mw_lh,
		a_mw_lhu;
	reg [31:0] b_mw_IR, b_mw_PC, b_mw_RES, b_mw_IO_RES, b_mw_ADDR, b_mw_store;
	reg
		b_mw_lb  /* synthesis syn_maxfan = 50 */,
		b_mw_lbu  /* synthesis syn_maxfan = 50 */,
		b_mw_lh,
		b_mw_lhu;
	reg b_mw_ASBL;
