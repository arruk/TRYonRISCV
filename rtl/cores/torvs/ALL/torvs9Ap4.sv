...
module torv32 (
	...
	wire a_rs1_HAZ = !a_fd_NOP & reads_rs1(
		a_fd_IR
	) & rs1ID(
		a_fd_IR
	) != 0 & ((writes_rd(
	...
	wire a_rs2_HAZ = !a_fd_NOP & reads_rs2(
		a_fd_IR
	) & rs2ID(
		a_fd_IR
	) != 0 & ((writes_rd(
	...
	wire b_rs1_HAZ = !b_fd_NOP & !control_HAZ & reads_rs1(
		b_fd_IR
	) & rs1ID(
		b_fd_IR
	) != 0 & ((writes_rd(
	...
	wire b_rs2_HAZ = !b_fd_NOP & !control_HAZ & reads_rs2(
		b_fd_IR
	) & rs2ID(
		b_fd_IR
	) != 0 & ((writes_rd(
	...
	wire ab_rs1_HAZ = !a_fd_NOP & reads_rs1(
		a_fd_IR
	) & rs1ID(
		a_fd_IR
	) != 0 & ((writes_rd(
	...
	wire ab_rs2_HAZ = !a_fd_NOP & reads_rs2(
		a_fd_IR
	) & rs2ID(
		a_fd_IR
	) != 0 & (  // mudar rs2ID (b_fd_IR) != 0
	(writes_rd(
		b_de_IR
	) & isLoad(
		b_de_IR
	...
	wire ba_rs1_HAZ = !b_fd_NOP & !control_HAZ & reads_rs1(
		b_fd_IR
	) & rs1ID(
		b_fd_IR
	) != 0 & ((writes_rd(
	...
	wire ba_rs2_HAZ = !b_fd_NOP & !control_HAZ & reads_rs2(
		b_fd_IR
	) & rs2ID(
		b_fd_IR
	) != 0 & ((writes_rd(
