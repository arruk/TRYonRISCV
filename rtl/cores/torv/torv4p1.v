...
`endif
	...
	reg [31:0] PC;
	wire [31:0] f_PC = d_JoB_now ? d_JoB_ADDR : em_JoB_now ? em_JoB_ADDR : PC;
	...
	reg de_e_m_fwd_rs1, de_e_w_fwd_rs1, de_e_m_fwd_rs2, de_e_w_fwd_rs2;
	reg de_predict;
	...
	wire [31:0] e_rs2 = e_m_fwd_rs2 ? em_RES  :
					e_w_fwd_rs2 ? wb_DATA :
						  de_rs2  ;
	*/
	wire [31:0] e_rs1 = de_e_m_fwd_rs1 ? em_RES : de_e_w_fwd_rs1 ? wb_DATA : de_rs1;

	wire [31:0] e_rs2 = de_e_m_fwd_rs2 ? em_RES : de_e_w_fwd_rs2 ? wb_DATA : de_rs2;
	...
	always @(posedge clk) begin
		...
		if (isBtype(de_IR)) BHT[de_BHTindex] <= incdec_sat(BHT[de_BHTindex], e_takeB);
	end
...
`ifdef BENCH
	...
	assign bench_hit = {1'b0, isBtype(de_IR) && (e_takeB == de_predict)};
