...
`endif
	...
	wire [31:0] d_JoB_ADDR = fd_IR[3:2] == 2'b01 ? RAS_0 : (fd_PC + (isJAL(
		fd_IR
	) ? Jimm(
		fd_IR
	) : Bimm(
	...
	wire [31:0] e_rs1 = e_m_fwd_rs1 ? em_RES : e_w_fwd_rs1 ? wb_DATA : de_rs1;

	wire [31:0] e_rs2 = e_m_fwd_rs2 ? em_RES : e_w_fwd_rs2 ? wb_DATA : de_rs2;
